...
def vis_px():
    ...
    norm = features.normalized(myMap.getMapData())[0]
    blur = features.blurred(myMap.img)[0]
    ...
    edge = features.edge_density(img, 100, amp = 1)[0].reshape(h,w)
    plt.subplot(111)
