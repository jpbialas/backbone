...
class PxClassifier():
    ...
    def __init__(self, n_estimators = 85, n_train = 265824, verbose = 1):
    ...
    def sample(self, labels, nsamples, EVEN):
        ...
        if EVEN:
            ...
            zero_samples = np.random.choice(zeros, n_min/2000)
            one_samples = np.random.choice(ones, n_min/2000)
    ...
    def fit(self, map_train, labels):
        ...
        self.model = RandomForestClassifier(n_estimators = self.n_estimators, n_jobs = -1, verbose = self.verbose)
