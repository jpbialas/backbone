    ...
    def predict_proba(self, map_test, label_name = "Jared", load = True, custom_data = None):
        ...
        if os.path.exists(p) and load:
            ...
            if custom_data is None:
                ...
                if label_name == 'haiti':
                    mean = np.array([1.54475244e+02, 1.57000643e+02, 1.61498352e+02, 1.50875895e+02, 1.53342391e+02, 1.57735212e+02, 6.59940175e-03, 3.65321869e+00, 2.21398994e-02, 1.25374231e-02, 4.80711809e-03, 3.10277880e-03, 3.09326723e-03, 3.84148695e-03, 3.60417791e-03, 3.18192264e-03, 4.02088855e-03, 3.60840313e-03, 3.92457673e-03, 4.15045054e-03, 3.17687086e-03, 3.69568275e-03, 3.41851864e-03, 4.68368528e-03, 2.66119256e-03])
                    std = np.array([5.31412290e+01, 5.15482230e+01, 5.04874732e+01, 2.86297360e+01, 2.76809515e+01, 2.93214337e+01, 9.68383603e-04, 5.32145529e-01, 9.74919668e-03, 2.33285700e-02, 1.48555488e-03, 1.17685381e-03, 1.20067730e-03, 1.29680867e-03, 1.27252066e-03, 1.19804419e-03, 1.34514399e-03, 1.26003032e-03, 1.30211886e-03, 1.34413618e-03, 1.21177880e-03, 1.29711027e-03, 1.24114765e-03, 1.42790230e-03, 1.13432309e-03])
                    haiti_mean = np.array([1.54475244e+02, 1.57000643e+02, 1.61498352e+02, 1.50875895e+02, 1.53342391e+02, 1.57735212e+02, 6.59940175e-03, 3.65321869e+00, 2.21398994e-02, 1.25374231e-02, 4.80711809e-03, 3.10277880e-03, 3.09326723e-03, 3.84148695e-03, 3.60417791e-03, 3.18192264e-03, 4.02088855e-03, 3.60840313e-03, 3.92457673e-03, 4.15045054e-03, 3.17687086e-03, 3.69568275e-03, 3.41851864e-03, 4.68368528e-03, 2.66119256e-03])
                    haiti_std = np.array([5.31412290e+01, 5.15482230e+01, 5.04874732e+01, 2.86297360e+01, 2.76809515e+01, 2.93214337e+01, 9.68383603e-04, 5.32145529e-01, 9.74919668e-03, 2.33285700e-02, 1.48555488e-03, 1.17685381e-03, 1.20067730e-03, 1.29680867e-03, 1.27252066e-03, 1.19804419e-03, 1.34514399e-03, 1.26003032e-03, 1.30211886e-03, 1.34413618e-03, 1.21177880e-03, 1.29711027e-03, 1.24114765e-03, 1.42790230e-03, 1.13432309e-03])
                    X_test = (((X_test - haiti_mean)/haiti_std)*std) + mean
